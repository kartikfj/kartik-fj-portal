    ...
    $.ajax({
        ...
        success: function(response) {
                 ...
                 var output= "<table id='salesman_performance_table' style='text-align:center; margin-left: auto; margin-right: auto;width: auto;'><thead ><tr>"
           		   +"<th class='se-brr'>Key Parmameters</th><th>Projection Q1</th><th>Actual Q1</th><th>Projection Q1</th><th>Actual Q2</th><th>Projection Q2 </th><th>Actual Q3</th><th>Projection Q3</th><th>Actual Q4</th><th>Projection Q4</th><th>Actual Total YTD</th><th>Target YTD</th><th>Target for (12 months)</th><th>Variance %</th></tr></thead><tbody>";
           		...
           		output += "<tr><td style='text-align:left;'class='se-brr'>Billing achieved</td><td>-</td><td style='text-align:right;'>" + formatNumber(Math.round(q1billing)) + "</td><td>-</td><td style='text-align:right;'>" + formatNumber(Math.round(q2billing)) + "</td><td>-</td><td style='text-align:right;'>" + formatNumber(Math.round(q3billing)) + "</td><td>-</td><td style='text-align:right;'>" + formatNumber(Math.round(q4billing)) + "</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>"
           		        ...
           		        + "<tr><td style='text-align:left;' class='se-brr'>Order Receivables. Avg per week Q1 & Q2</td><td>-</td><td>" + formatNumber(Math.round(q1orderAvg)) + "</td><td>-</td><td>" + formatNumber(Math.round(q2orderAvg)) + "</td><td>-</td><td>" + formatNumber(Math.round(q3orderAvg)) + "</td><td>-</td><td>" + formatNumber(Math.round(q4orderAvg)) + "</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>"
           		        + "<tr><td style='text-align:left;' class='se-brr'>Total Receivables Outstanding</td><td>-</td><td>" + formatNumber(Math.round(q1totalRecivable)) + "</td><td>-</td><td>" + formatNumber(Math.round(q2totalRecivable)) + "</td><td>-</td><td>" + formatNumber(Math.round(q3totalRecivable)) + "</td><td>-</td><td>" + formatNumber(Math.round(q4totalRecivable)) + "</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>"
           		        + "<tr><td style='text-align:left;' class='se-brr'>Receivables above 120 days</td><td>-</td><td>" + formatNumber(q1above120) + "</td><td>-</td><td>" + formatNumber(q2above120) + "</td><td>-</td><td>" + formatNumber(q3above120) + "</td><td>-</td><td>" + formatNumber(q4above120) + "</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>"
