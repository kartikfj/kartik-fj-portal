			 ...
			 for(var i=${currWeek},s2CntSum=0,s3CntSum=0,s4CntSum=0,s5CntSum=0,s2ValSum=0,s3ValSum=0,s4ValSum=0,s5ValSum=0; i>= 1 ; i --){
					...
					var filteredValues = reportsList.find( singleRw =>  singleRw.division == item &&  singleRw.company == divisionItem  && singleRw.week == weekTmp  );
					 ...
					 if(typeof filteredValues === 'undefined'){
			    		 ...
			    		 //console.log("filteredValues== "+totS2Count+"--"+totS3Count+"--"+totS4Count);
...
function createReport(){
	...
	// console.dir(extractedReport);
	 ...
	 output += "<td class='txt-right spclHeaderTotal' scope='col' >"+Math.round(item.s2CntSum)+"</td>";
	 output += "<td class='txt-right spclHeaderTotal' scope='col' >"+Math.round(item.s3CntSum)+"</td>";
	 output += "<td class='txt-right spclHeaderTotal' scope='col' >"+Math.round(item.s4CntSum)+"</td>";
	 output += "<td class='txt-right spclHeaderTotal' scope='col' >"+Math.round(item.s5CntSum)+"</td>";
	 ...
	 output += "<td class='txt-right spclHeaderAvg' scope='col' >"+Math.round(item.s5CntSum/weeknumber)+"</td>";
	  ...
	  output += "<td class='txt-right spclHeaderTotal' scope='col' >"+extractValue(Math.round(item.s2ValSum))+"</td>";
	  output += "<td class='txt-right spclHeaderTotal' scope='col' >"+extractValue(Math.round(item.s3ValSum))+"</td>";
	  output += "<td class='txt-right spclHeaderTotal' scope='col' >"+extractValue(Math.round(item.s4ValSum))+"</td>";
	  output += "<td class='txt-right spclHeaderTotal' scope='col' >"+extractValue(Math.round(item.s5ValSum))+"</td>";
...
function downloadReports(weeknumber, extractedReport){ 
	...
	exportTable +="<tr><th>Company</th><th>Division</th><th></th><th>Total/S2</th><th>Total/S3</th><th>Total/S4</th><th>Total/S5</th><th>Weekly Avg/S2</th><th>Weekly Avg/S3</th><th>Weekly Avg/S4</th><th>Weekly Avg/S5</th>";
	 ...
	 extractedReport.map(item => { 
		 exportTable += "<tr><td>"+item.company+"</td><td>"+item.division+"</td><td>Count</td><td>"+Math.round(item.s2CntSum)+"</td><td>"+Math.round(item.s3CntSum)+"</td><td>"+Math.round(item.s4CntSum)+"</td><td>"+Math.round(item.s5CntSum)+"</td><td>"+Math.round(item.s2CntSum/weeknumber)+"</td><td>"+Math.round(item.s3CntSum/weeknumber)+"</td><td>"+Math.round(item.s4CntSum/weeknumber)+"</td><td>"+Math.round(item.s5CntSum/weeknumber)+"</td>";		
		  for(var i=${currWeek};i>=1;i--){ 
		  ...
		  exportTable += "</tr><tr><td>"+item.company+"</td><td>"+item.division+"</td><td>Value</td> <td>"+extractValue(Math.round(item.s2ValSum))+"</td><td>"+extractValue(Math.round(item.s3ValSum))+"</td><td>"+extractValue(Math.round(item.s4ValSum))+"</td><td>"+extractValue(Math.round(item.s5ValSum))+"</td><td>"+extractValue(Math.round(item.s2ValSum/weeknumber))+"</td><td>"+extractValue(Math.round(item.s3ValSum/weeknumber))+"</td><td>"+extractValue(Math.round(item.s4ValSum/weeknumber))+"</td><td>"+extractValue(Math.round(item.s5ValSum/weeknumber))+"</td>";
