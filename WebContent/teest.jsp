	                           ...
	                           <div class="panel-heading" id="fj-page-head">                        
	                            ...
	                            <div>
	                                <div class="sh_d2">
	                                 ...
	                                 <div class="l_left1">
	                                	  <div class="n_text_narrow" id="frdt_label">Passenger</div>
	                                       <input type="text" class="text_area" style="width:95%" id="traveluName" name="travelUName"  value="${businessleave.travelUName}" required="required">
	                                 </div> 
	                                 <div class="l_left1">
	                                	  <div class="n_text_narrow" id="frdt_label">Designation</div>
	                                       <input type="text" class="text_area" style="width:95%" id="traveluDesignation" name="travelUDesignation" tabindex="1" value="${businessleave.travelUDesignation}" required="required">
	                                 </div>    
	                                 <div class="l_right1">
	                                	  <div class="n_text_narrow" id="frdt_label">Division</div>
	                                       <input type="text" class="leave_text" style="width:60%" id="traveluDivision" name="travelUDivision" tabindex="1" value="${businessleave.travelUDivision}" required="required">
	                                </div>   
                                </div>  <br/><br/>
	                             ...
	                             <div class="panel-heading" id="fj-page-head">                        
									...
									<div>
	                                  ...
	                                  <div class="l_left1">
	                                   ...
	                                   <div class="l_left1" style="width:50%">
                                ...
                                <div class="l_left1">
                                    <div class="n_text_narrow">Customer Name / Project Detail <span>*</span></div>
                              ...
                              <br/><br/>
	                            ...
	                            <div class="panel-heading" id="fj-page-head">                        
			                        <h4 class="text-left">
				                      ...
				                      <div class="sh_d2">
		                                	  <div class="n_text_narrow" id="frdt_label">Date of Request<span>*</span></div>
		                                       <input type="text" class="select_box" style="width:45%" id="dateofReq" name="dateofReq" autocomplete="on" required="required">	                                      
		                                    </div>                  
	                                  <div class="l_left1">
	                                	  <div class="n_text_narrow" id="frdt_label">Date of Travel<span>*</span></div>
	                                       <input type="text" id="datepicker-13" style="width:95%" class="select_box" name="fromdate" value="${param.fromdate}" autocomplete="off" required="required">
	                                   </div>
	                                   <div class="l_left1" style="width:50%">
	                                       <div class="n_text_narrow">Date of Return<span>*</span></div>
	                                       <input type="text" readonly class="select_box"  style="width:47%" id="datepicker-14" name="todate" value="${param.todate}"/>
	                                   </div> 	                                     
                                  
                                   
	                                    <div class="l_left1">
	                                       <div class="n_text_narrow">Traveling from Airport<span>*</span></div>
	                                       <input type="text" class="select_box"  style="width:95%" id="fromAirport" name="fromAirport" value="${param.fromAirport}"/>
	                                   </div> 
	                                    <div class="l_left1">
	                                       <div class="n_text_narrow">Preferable Time<span>*</span></div>
	                                       <input type="text" class="select_box" style="width:95%" id="pfromTime" name="pfromTime" value="${param.pfromTime}"/>
	                                   </div>  
	                                    <div class="l_left1">
	                                       <div class="n_text_narrow">Return from Airport<span>*</span></div>
	                                       <input type="text" class="select_box"  style="width:95%" id="retrunAirport" name="retrunAirport" value="${param.retrunAirport}"/>
	                                   </div> 
	                                    <div class="l_left1">
	                                       <div class="n_text_narrow">Preferable Time<span>*</span></div>
	                                       <input type="text" class="select_box"  style="width:95%" id="preturnTime" name="preturnTime" value="${param.preturnTime}"/>
	                                   </div>  
                                ...
                                <div class="l_left1">
                                    <div class="n_text_narrow">Customer Name / Project Detail <span>*</span></div>
                                    <textarea name="projectDetails" style="width:95%" maxlength="100"  class="mybox" id="projectDetails">${param.projectDetails}</textarea>
                                </div>
                                 <div class="l_left1">
                                    <div class="n_text_narrow">Purpose <span>*</span></div>
                                    <textarea name="purpose" style="width:95%" maxlength="200" cols="10" rows="2" class="mybox" id="purpose">${param.purpose}</textarea>
                                </div>
                                 <div class="l_left1">
                                    <div class="n_text_narrow">Other Remarks </div>
                                    <textarea name="otherDetails" style="width:95%" maxlength="200" cols="10" rows="2" class="mybox" id="otherDetails">${param.otherDetails}</textarea>
