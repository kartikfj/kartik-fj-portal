<%-- 
    Document   : SIP PAGE FOR DMS SALES DASHABORD
--%>
...
$(document).ready(function($) {
     ...
     window.location.href = "salesManagerPerf";
});
      ...
      <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="DmInfo.jsp"  class="active"><i class="fa fa-dashboard"></i><span>Sales Engineers Performance</span></a></li>
             <c:if test="${!empty fjtuser.subordinatelist}" > <li><a href="DisionInfo.jsp"><i class="fa fa-line-chart"></i><span>Sub Division Performance</span></a></li></c:if>
              <c:if test="${!empty fjtuser.subordinatelist}" ><li ><a href="#"><i class="fa fa-pie-chart"></i><span>Division Performance</span></a></li></c:if>
            <!--   <li><a href="customer.jsp"><i class="fa fa-table"></i><span>Customer Performance</span></a></li>
