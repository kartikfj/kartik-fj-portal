...
public class EmailHrEvaluation {
	...
	private int readDefaultSenderMailProps() {
		...
		ResultSet rs = null;
		String usql = "select emailid,password,host,port,is_ssl,user_name from  emailconf where usagetype='HREVL'";
		try {
	...
	public String getMessageFooter() {
		String div = " "
				+ "<b style=\"color:red;\">This is an auto-generated email. Please do not reply to this email.</b> <br/>  "
				+ "</td></tr></table>";
