...
public class SipDivBookingSummary {

	private String division = null;
	private String month_perc = null;
	...
	public String getMonth_perc() {
		return month_perc;
	}

	public void setMonth_perc(String month_perc) {
	...
	public SipDivBookingSummary(String division, String month_perc, String ytd_perc, String month_actual,
			String month_target) {
		super();
		this.division = division;
		this.month_perc = month_perc;
	...
	public SipDivBookingSummary(String division, String curr_yrt, String curr_yra, String prev_yrt, String prev_yra,
