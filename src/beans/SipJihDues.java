...
public class SipJihDues {
	...
	public double getQtnAmt() {
		return qtnAmt;
	}

	public void setQtnAmt(double qtnAmt) {
		this.qtnAmt = qtnAmt;
	}
	...
	public SipJihDues(String slesCode, String sys_id, String qtnDate, String qtnCode, String qtnNo, String custCode,
			String custName, String projectName, String consultant, int qtnAMount, String qtnStatus, String remarks,
			String poDate, String invoiceDate) {
		super();
		this.slesCode = slesCode;
		this.sys_id = sys_id;
		this.qtnDate = qtnDate;
	...
	public SipJihDues(String slesCode, String sys_id, String qtnDate, String qtnCode, String qtnNo, String custCode,
			String custName, String projectName, String consultant, Double qtnAMount, String qtnStatus, String remarks,
			String updatedOn) {
		super();
		this.slesCode = slesCode;
		this.sys_id = sys_id;
		...
		this.projectName = projectName;
		this.consultant = consultant;
		this.qtnAmt = qtnAMount;
		this.qtnStatus = qtnStatus;
		this.remarks = remarks;
		this.updatedDate = updatedOn;
	}

	public SipJihDues(String remarksType, String remarkTypeDesc) {
		super();
		this.remarksType = remarksType;
		this.remarkTypeDesc = remarkTypeDesc;
	}
	...
	public SipJihDues(String lostType, long lostCount, long lostValue) {
		super();
		this.lostType = lostType;
		this.lostCount = lostCount;
		this.lostValue = lostValue;
	...
	public SipJihDues(String projectName, String consultant, String qtnCode, String qtnNo, String qtnDate,
			int qtnAMount) {
		super();
		this.qtnDate = qtnDate;
		this.qtnCode = qtnCode;
